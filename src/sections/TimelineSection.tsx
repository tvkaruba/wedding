...
const timelineItems = [
  {
    time: '11:30',
    title: 'Регистрация',
    sub: 'Чайковский ЗАГС. Участие по желанию, всем будем рады',
  },
  {
    time: '18:00',
    title: 'Банкет',
    sub: 'Ужин, веселые конкурсы, тёплые речи',
  },
  {
    time: '21:00',
    title: 'Боулинг',
    sub: 'Играют все, а после - бильярд для тех, кто не танцует :)',
  },
  {
    time: '22:00',
    title: 'Вечеринка',
    sub: 'Продолжение банкета, танцы до утра (нет)',
  },
];
